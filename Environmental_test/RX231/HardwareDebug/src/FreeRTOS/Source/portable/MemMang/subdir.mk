...
src/FreeRTOS/Source/portable/MemMang/%.obj: ../src/FreeRTOS/Source/portable/MemMang/%.c 
	...
	@echo src\FreeRTOS\Source\portable\MemMang\cDepSubCommand.tmp=
	@sed -e "s/^/ /" "src\FreeRTOS\Source\portable\MemMang\cDepSubCommand.tmp"
	ccrx -subcommand="src\FreeRTOS\Source\portable\MemMang\cDepSubCommand.tmp" -output=dep="$(@:%.obj=%.d)" -MT="$(@:%.d=%.obj)" -MT="$(@:%.obj=%.d)" "$<"
	@echo src\FreeRTOS\Source\portable\MemMang\cSubCommand.tmp=
	@sed -e "s/^/ /" "src\FreeRTOS\Source\portable\MemMang\cSubCommand.tmp"
